...
public class TileManager {
    ...
    public void draw(Graphics2D g2)  {
        ...
        while(worldCol < gp.maxWorldCol && worldRow < gp.maxWorldRow)  {
            ...
            if (worldX + gp.tileSize > gp.getPlayer().getWorldX() - gp.getPlayer().getScreenX() &&
                worldX - gp.tileSize < gp.getPlayer().getWorldX() + gp.getPlayer().getScreenX() &&
                worldY + gp.tileSize > gp.getPlayer().getWorldY() - gp.getPlayer().getScreenY() &&
                worldY - gp.tileSize < gp.getPlayer().getWorldY() + gp.getPlayer().getScreenY())  {
