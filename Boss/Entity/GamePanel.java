...
public class GamePanel extends JPanel implements Runnable, KeyListener {
    ...
    public GamePanel() {
        ...
        // Initialize monsters and boss
        setupMonsters();
        iblee = new Iblee(this);
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (gameState == STATE_SELECTION) {
            ...
            drawGameOver(g2);
        } else if (gameState == STATE_GAME_WIN) {
            drawGameWin(g2);
        }
    ...
    public void keyPressed(KeyEvent e) {
        ...
        } else if (gameState == STATE_GAME_OVER || gameState == STATE_GAME_WIN) {
